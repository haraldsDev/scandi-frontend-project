			...
			<div className="user-bar ba">
				<div>
					<div id="Users">
						...
						<div className="flex flex-wrap mt3 mb4">
						...
						<div className="flex flex-wrap flex-start mb3">
							<div id="Userpic1" className="ml3 mr2">pic1</div>
							<div id="Userpic2" className="mr2">pic2</div>
							<div id="+76" className="txt39 mr2">+76</div>
							<div id="Liked-this opacity: 0.6" className="txt7 mr2">Liked this</div>
						</div>
